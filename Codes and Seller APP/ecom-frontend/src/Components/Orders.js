            ...
            <OrderDetail>
              <AddressComponent>
                ...
                <div>
                  ...
                  <p>Your NFT wallet address : {order.address.NFTaddress}</p>
              ...
              <OrderBasket>
                ...
                {order.products.map((product) => (
                  <Product>
                    ...
                    <NFTbutton onClick={()=> window.open("http://localhost:3000/", "_blank")} style={{color:'white', fontWeight:'600',cursor:"pointer"}}>Your NFT based waranty</NFTbutton>
                  </Product>
                ))}
              </OrderBasket>
            </OrderDetail>
